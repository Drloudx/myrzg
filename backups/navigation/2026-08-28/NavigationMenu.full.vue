...
const navList = [
  ...
  { name: '事件图鉴', path: '/events', icon: '/images/event/e001.png' },
  { name: '副本图鉴', path: '/dungeons', icon: '/images/instancepanel/map_fb_yzdj.png' },
  { name: '兑换', path: '/exchange', icon: '/ui/zw.png' },
  { name: '其他', path: '/rewards', icon: '/ui/item_00002.png' }
]
