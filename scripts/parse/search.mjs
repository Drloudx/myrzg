...
export function build(deps = {}) {
  ...
  const result = buildSearchData({
    ...
    dailyWorkJson: readJson('dailyWork.json'),
    ...
    homeItemJson: readJson('homeItem.json'),
    ...
    shopJson: readJson('shop.json'),
    generalJson: readJson('general.json'),
    packDisplayJson: readJson('packDisplay.json'),
    activityListJson: readJson('activityList.json'),
    activityDailyJson: readJson('activityDaily.json'),
    homeLevelJson: readJson('homeLevel.json'),
    campResearchJson: readJson('campResearch.json'),
    fileGatherJson: readJson('fileGather.json'),
